...
function resolveFile(urlPath) {
  if (urlPath === '/' || urlPath === '/index.html') {
    return path.join(here, 'hint-card-site.html')
  }
  if (urlPath === '/hint-card-site.js') {
    return path.join(here, 'hint-card-site.js')
  }
...
server.listen(PORT, HOST, () => {
  console.log(`Prototype (throwaway) http://${HOST}:${PORT}/?variant=A`)
  console.log('A Nothing extra · B Always-on Site chip · C Inherited footer')
})
